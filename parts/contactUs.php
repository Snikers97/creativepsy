<section class="u-align-center u-black u-clearfix u-section-8 blocksColor-3" id="carousel_a7df">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-grey-75 u-text-1 contactUsTitle textColor">Հետադարձ կապ</h1>
            ...
            <div class="u-layout-row">
              <div class="u-align-center-xs u-align-left-lg u-align-left-md u-align-left-sm u-align-left-xl u-container-style u-layout-cell u-left-cell u-size-20 u-layout-cell-1">
                <div class="u-container-layout u-valign-top u-container-layout-1">
                  <h2 class="u-text u-text-3 textColor">don't be shy</h2>
                  <p class="u-text u-text-4 textColor">Feel free to get in touch with me. I am always open to discussing new projects, creative ideas or opportunities to be part of your visions.</p>
                  <span class="u-icon u-icon-circle u-text-palette-3-base u-icon-1">
                    <svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 512 512" style="">
                      <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-7817"></use>
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="svg-7817" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve" class="u-svg-content"><g><g>
                  ...
                  <h6 class="u-text u-text-5 textColor">էլ․ հասցե<br>psychologicalcamp@gmail.com<br>
                  ...
                  <h6 class="u-text u-text-6 textColor">Հեռախոսահամար<br>+374 98 892 890
                  </h6>
                </div>
              </div>
                  ...
                  <div class="u-expanded-width u-form u-form-1">
                    <form action="#" method="POST" class="u-clearfix u-form-spacing-19 u-form-vertical u-inner-form" style="padding: 10px" source="custom" name="form">
                      ...
                      <div class="u-align-left u-form-group u-form-submit u-form-group-5">
                        <a href="#" class="u-btn u-btn-round u-btn-submit u-button-style u-palette-3-base u-radius-30 u-btn-1" style="background-color: #017479!important; color: #ffffff!important;">Ուղարկել</a>
                        <input type="submit" value="submit" class="u-form-control-hidden">
                      </div>
                      <div class="u-form-send-message u-form-send-success textColor"> Thank you! Your message has been sent. </div>
                      <div class="u-form-send-error u-form-send-message textColor"> Unable to send your message. Please fix errors then try again. </div>
